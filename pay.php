...
$error_message = "Payment Unsuccessful";
$khalti_public_key = "bd341b7ec29847abb5eeb489adb4f74f";



$amount = 10;
$uniqueProductId = "premium";
$uniqueUrl = "/";
$uniqueProductName = "JobNexus Premium";
$successRedirect = "payment_success.php"; // change this url , it will be the page user will be redirected after successful payment
